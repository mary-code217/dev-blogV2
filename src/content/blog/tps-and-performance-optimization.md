...
TPS(Transaction Per Second)는 **초당 처리할 수 있는 트랜잭션 수**다. 쉽게 말해 "1초에 몇 건의 작업(비즈니스 처리)을 완료할 수 있는가"를 나타내는 지표다. 요청 단위를 세는 RPS(Request Per Second)와는 다른 개념으로, 트랜잭션 하나가 여러 요청을 포함할 수 있다.
